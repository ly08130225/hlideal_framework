package com.hlideal.common.functions.hlideal.utils.lang.exception;

import com.hlideal.common.functions.hlideal.utils.result.ResultInfo;
import com.hlideal.common.functions.hlideal.utils.result.StandardResultInfo;
import com.hlideal.common.functions.hlideal.utils.result.Status;
...
public class ResultException extends RuntimeException {
	...
	public ResultInfo toResultInfo() {
		return new StandardResultInfo(Status.FAIL, this.code, this.description == null ? getMessage() : this.description);
	}
