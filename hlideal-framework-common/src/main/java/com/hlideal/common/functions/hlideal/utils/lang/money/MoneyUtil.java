package com.hlideal.common.functions.hlideal.utils.lang.money;
  ...
  public static String getCHSNumber(Money m)
  {
    ...
    for (int i = 0; i < tmp_int_char.length; i++)
    {
      ...
      if (tmp_int_char.length <= 5) {
        tmp_chs[tab] = CHS_NUMBER[((int)java.lang.Float.parseFloat(tmp_int_char[i] + ".0"))];
    ...
    if (tmp.length == 1) {
      if (tmp[0] != '0')
        chs = chs + "元" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder().append(tmp[0]).append(".0").toString()))] + "角整";
      else
        chs = chs + "元整";
    }
    else if ((tmp[1] != '0') && (tmp[0] != '0')) {
      chs = chs + "元" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder().append(tmp[0]).append(".0").toString()))] + "角" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder().append(tmp[1]).append(".0").toString()))] + "分";
    }
    else if ((tmp[1] != '0') && (tmp[0] == '0'))
      chs = chs + "元零" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder().append(tmp[1]).append(".0").toString()))] + "分";
    else if ((tmp[1] == '0') && (tmp[0] != '0'))
      chs = chs + "元" + CHS_NUMBER[((int)java.lang.Float.parseFloat(new java.lang.StringBuilder().append(tmp[0]).append(".0").toString()))] + "角";
    else if ((tmp[1] == '0') && (tmp[0] == '0')) {
      chs = chs + "元整";
    }
