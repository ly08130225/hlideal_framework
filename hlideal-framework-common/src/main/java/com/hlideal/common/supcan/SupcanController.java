...
package com.hlideal.common.supcan;
...
import com.hlideal.common.base.utils.CacheUtils;
import com.hlideal.common.base.utils.SpringContextHolder;
import com.hlideal.common.supcan.treelist.cols.Col;
...
import com.hlideal.common.supcan.annotation.treelist.SupTreeList;
import com.hlideal.common.supcan.annotation.treelist.cols.SupCol;
import com.hlideal.common.supcan.annotation.treelist.cols.SupGroup;
import com.hlideal.common.supcan.treelist.TreeList;
import com.hlideal.common.supcan.treelist.cols.Group;
...
public class SupcanController extends BaseController {
	...
	public TreeList treeList(@PathVariable("typeAlias") String typeAlias) {
		...
		boolean useCache = AppConfiguration.getInstance().getString("supcan.useCache") == "true";
		if (useCache){
