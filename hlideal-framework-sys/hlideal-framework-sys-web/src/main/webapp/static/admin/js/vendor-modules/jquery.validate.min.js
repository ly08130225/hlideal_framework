	...
	a.extend(a.fn, {
		...
		prototype: {
			...
			hideThese: function(a) {
				a.not(this.containers).text(""), this.addWrapper(a).addClass('hide').removeClass('action-error');
			},
			valid: function() {
				return 0 === this.size()
			},
			...
			defaultShowErrors: function() {
				...
				this.toHide = this.toHide.not(this.toShow), this.hideErrors(), this.addWrapper(this.toShow).removeClass('hide').addClass('action-error');
			},
