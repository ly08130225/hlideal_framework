define(function (require, exports, module) {
	...
	require('yrkj/jquery.yrkj.validate');
	require('yrkj/jquery.yrkj.combobox');
	require('yrkj/jquery.yrkj.combotree');
	require('yrkj/jquery.yrkj.checkbox');
	require('yrkj/jquery.yrkj.table');
	require('datepicker');
	require('upload');
	...
	$.extend(YUI.prototype, {
        ...
        cleanValidateText: function (target) {
            $(target).parent().find('div[class*="yrkj-validation"]').remove();
        },
		/**
		 ...
		 * */
		cleanValidateText: function (target) {
			$(target).find('span[class*="yrkj-validation"]').remove();
		},
...
seajs.use(['jquery', 'yrkj/jquery.yrkj.page.callback'], function ($, CALLBACK) {
