define(function (require, exports, module) {
	...
	// 插件的定义
	$.fn.YWindow = function (options) {
		//options如果为string，表示是方法调用
		if (typeof options == 'string') {
			var method = $.fn.YWindow.methods[options];
			if (method) {
				return method(this);
			}
		}
		...
		var opts = $.extend({}, $.fn.YWindow.defaults, options);
		this.each(function () {
			var html = [],//弹出框的html
			...
			if (!opts.closed) {
				...
				$("div[class='yrkj-window']:visible").each(function () {
				...
				html.push('<div  tabindex="-1"  id="' + window_id
					+ '" class="yrkj-window" style="width: ' + window_width + 'px;height: ' + window_height
			...
			$(this).html("");
			opts.divTarget = $(this);
			opts.target = body.children("div:last-child").find(".yrkj-window");
			opts.isInit = true;
